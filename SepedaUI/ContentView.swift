...
//  SepedaUI
//
//  Created by Darell Legoferdanu on 03/02/21.
//
...
struct ContentView: View {
    ...
    let data: [ProductModel] = [
        ...
        ProductModel(id: 7, namaProduk: "Exotic M56", fotoProduk: "foto7", hargaProduk: 6000000, lokasi: "Kab. Banyuwangi", ratingCount: 5, jumlahRating: 56),
